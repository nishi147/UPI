                ...
                <div className="glass-panel" style={{ textAlign: 'center' }}>
                    ...
                    {config && config.qrCodeUrl ? (
                        <div style={{ marginBottom: '1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <a href={getUpiLink()}>
                                <img src={`http://localhost:5000${config.qrCodeUrl}`} alt="QR Code" style={{ width: '250px', height: '250px', objectFit: 'contain', borderRadius: '12px', border: '8px solid var(--primary)', marginBottom: '1rem' }} />
                            </a>
